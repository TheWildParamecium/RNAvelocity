...
#cellranger count --id=azoospermia36 \
#                   --transcriptome=../refGenomes/refdata-gex-GRCh38-2020-A \
#                   --fastqs=../inputFiles/azoospermia36 \
#                   --expect-cells=6000 \
#                   --localcores=48 \
#                   --localmem=96 \
#                   --localvmem=32 
...
velocyto run10x -m ../refGenomes/hg38_repeat_msk.gtf ./azoospermia37 ../refGenomes/refdata-gex-GRCh38-2020-A/genes/genes.gtf
